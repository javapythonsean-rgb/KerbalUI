...
Give Kerbal Space Program 1 a vivid blue interface without changing its layout
or fonts. Kerbal UI combines dark navy panels with bright blue frames, gold and
teal instruments, periwinkle controls, green status highlights, and KSP2-red
warnings across flight, the VAB/SPH, KSC, KAL, and shared windows.
